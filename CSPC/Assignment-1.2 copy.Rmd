...
A file path indicates the location of individual files. Absolute paths always point to the same location while relative paths, depending on the current directory, point to diffrent locations. 
